...
void GpuLife::initRandom() {
    ...
    cl_int err = clEnqueueWriteBuffer(commandQueue, dataBuffer, CL_TRUE, 0, sizeof(ubyte) * m_worldSize, data.data(), 0, nullptr, nullptr);
...
std::ostream &operator<<(std::ostream &os, GpuLife &gpuLife) {
    ...
    clEnqueueReadBuffer(gpuLife.commandQueue, gpuLife.dataBuffer, CL_TRUE, 0, sizeof(ubyte) * gpuLife.m_worldSize, data.data(), 0, nullptr, nullptr);
